<script lang="ts">
	...
	import Gutter from '$src/components/utility/gutter.svelte';
	import Width from '$src/components/utility/width.svelte';
...
<Gutter class="py-10">
	<Width size="small" class="rounded-2xl bg-red-50 py-16 px-6 text-center sm:py-20 lg:px-8">
		<h2 class="">
